...
let company = 'Facebook,Google,Miscrosoft,Apple,IBM,Oracle,Amazon'
...
console.log(words.lastIndexOf('because'))
//Use search to find the position of the first occurrence of the word because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
let letter = "You cannot end a sentence with because because because is a conjunction    "
console.log(letter.search('because'))
//Use trim() to remove any trailing whitespace at the beginning and the end of a string.E.g ' 30 Days Of JavaScript '.
console.log(letter.trim())
// console.log(letter.trimEnd())
